    ...
    <footer className='foot_container'>
      <div className='foot_g_section'>
        ...
        <section className='foot_f_social'>
          <Link>
            <img className='foot_socialIcon' src={x} alt='Twitter/X' />
          </Link>
          <Link>
            <img className='foot_socialIcon' src={linkedin} alt='Twitter/X' />
          </Link>
          <Link>
            <img className='foot_socialIcon' src={facebook} alt='Twitter/X' />
          </Link>
        </section>
        <div className='foot_divider'></div>
        <section className='foot_s_section'>
          <div className='footer_terms'>
            <Link className='linkBtn'>{footer.other[0]}</Link>
            <Link className='linkBtn'>{footer.other[1]}</Link>
          </div>
